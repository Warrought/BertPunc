...
if __name__ == '__main__':
    ...
    print('LOADING DATA...')
    data=load_file('data/sviperm_train')
    
    data_train, data_valid = train_test_split(data, test_size=0.33, random_state=42)
    
    data_test = load_file('data/sviperm_test')
    #data_train = load_file('data/LREC/train2012.txt')
    #data_valid = load_file('data/LREC/dev2012.txt')
    #data_test = load_file('data/LREC/test2011.txt')
    #data_test_asr = load_file('data/LREC/test2011asr.txt')
